...
def plot_keyword_clouds_by_cluster(csv_path, cluster_column="cluster", keyword_column="keywords", delimiter=",", save_dir="keyword_clouds_songs"):
    # Load CSV
    ...
    for cluster_id in clusters:
        ...
        plt.axis("off")
        plt.title(f"Cluster {cluster_id} Keywords (Songs)")
        plt.tight_layout()

        # Save image
        save_path = os.path.join(save_dir, f"cluster_{cluster_id}_keywords_songs.png")
